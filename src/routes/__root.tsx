...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "مكتب طوس العقارية" },
      { name: "description", content: "مكتب طوس العقارية — منصة للعروض والاستفسارات العقارية في المملكة العربية السعودية." },
      { name: "author", content: "مكتب طوس العقارية" },
      { property: "og:title", content: "مكتب طوس العقارية" },
      { property: "og:description", content: "مكتب طوس العقارية — منصة للعروض والاستفسارات العقارية في المملكة العربية السعودية." },
